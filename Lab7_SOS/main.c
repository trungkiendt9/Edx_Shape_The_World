...
// Input from PF4(SW1) and PF0(SW2), output to PF3 and PF1 (Green + Red LEDs)
// Pressing both SW1 and SW2 to starts SOS (Yellow = Red + Green LEDs flashes SOS at same time).
...
// If either SW1 or SW2 are off, the LEDs should be off.

// Authors: Do Trung Kien, Jonathan Valvano and Ramesh Yerraballi
// Date: Feb 2, 4
...
int main(void){
  ...
  PortF_Init(); // Init port PF4 PF3, PF1 PF0    
...
// PF4, PF0 is input SW1, SW1 and PF3,PF2 PF1 is output Green+Red = Yellow LEDs
// Inputs: None
// Outputs: None
// Notes: ...
